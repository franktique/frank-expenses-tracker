...
export const RATE_TYPES = {
  EA: {
    ...
    shortLabel: "EA",
    description: "Tasa efectiva anual - el rendimiento real en un año con interés compuesto",
  },
  EM: {
    code: "EM",
    label: "Efectiva Mensual",
    shortLabel: "E. Mensual",
    description: "Tasa efectiva mensual - el rendimiento real en un mes (ej: 1.5% mensual)",
  },
  ED: {
    code: "ED",
  ...
  NM: {
    ...
    description: "Tasa mensual que ves en extractos o facturas (ej: 1.1% mensual)",
  },
  NA: {
    code: "NA",
    label: "Nominal Anual",
...
export type CreateInterestRateScenarioInput = z.infer<typeof CreateInterestRateScenarioSchema>;
export type UpdateInterestRateScenarioInput = z.infer<typeof UpdateInterestRateScenarioSchema>;
...
export const INTEREST_RATE_ERROR_MESSAGES = {
  ...
  TABLES_NOT_FOUND: "Las tablas del simulador de tasas no existen. Ejecute la migración primero.",
 ...
 */
export function formatRateAsPercentage(rate: number, decimals: number = 4): string {
