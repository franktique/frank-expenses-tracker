...
export async function migrateAddTipoGasto() {
  try {
    console.log(
      'Starting migration: Add tipo_gasto column to categories table'
    );
    ...
    console.log(
      "✓ Successfully added tipo_gasto column to categories table with default value 'F' (Fijo)"
    );
    ...
    console.log(
      "✓ Successfully set default 'F' value for all existing categories"
    );
