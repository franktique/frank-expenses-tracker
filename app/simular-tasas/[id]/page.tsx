...
async function getScenario(id: string): Promise<InterestRateScenario | null> {
  try {
    ...
    const response = await fetch(`${baseUrl}/api/interest-rate-scenarios/${id}`, {
      cache: "no-store",
    });
...
export default async function ViewInterestRateScenarioPage({ params }: PageParams) {
    ...
    <div className="container mx-auto py-6 px-4 max-w-6xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Editando simulación de tasa guardada. Los cambios se pueden guardar con el mismo nombre
          o con uno nuevo.
        </p>
      </div>
