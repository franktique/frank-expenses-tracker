...
describe('PeriodsView', () => {
  ...
  describe('Add Period Dialog', () => {
    ...
    it('handles creation errors', async () => {
      const mockAddPeriod = jest
        .fn()
        .mockRejectedValue(new Error('Period already exists'));
  ...
  describe('Period Editing', () => {
    it('opens edit dialog when edit button is clicked', () => {
      ...
      expect(
        screen.getByText('Actualiza los detalles del periodo')
      ).toBeInTheDocument();
    });
  ...
  describe('Period Deletion', () => {
    ...
    it('handles deletion errors', async () => {
      const mockDeletePeriod = jest
        .fn()
        .mockRejectedValue(new Error('Cannot delete active period'));
      ...
      await waitFor(() => {
        expect(mockToast).toHaveBeenCalledWith({
          title: 'Error',
          description:
            'No se pudo eliminar el periodo: Cannot delete active period',
          variant: 'destructive',
        });
      });
    });
  ...
  describe('Period Activation/Deactivation', () => {
    it('shows activation confirmation when another period is active', () => {
      ...
      expect(
        screen.getByText('Confirmar Activación de Periodo')
      ).toBeInTheDocument();
    ...
    it('cancels activation confirmation', () => {
      ...
      expect(
        screen.queryByText('Confirmar Activación de Periodo')
  ...
  describe('Error Handling', () => {
    ...
    it('shows retry notification for failed operations', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/Operación fallida: Activar/)
        ).toBeInTheDocument();
    ...
    it('retries failed operations', async () => {
      ...
      await waitFor(() => {
        ...
        expect(mockToast).toHaveBeenCalledWith({
          title: 'Periodo activado',
          description:
            'El periodo ha sido establecido como activo exitosamente',
        });
      });
    });
  ...
  describe('Accessibility', () => {
    it('has proper ARIA labels and roles', () => {
      ...
      expect(
        screen.getByRole('button', { name: /nuevo periodo/i })
      ).toBeInTheDocument();
      expect(
      ...
      const actionButtons = screen.getAllByRole('button', {
        name: /activar|desactivar|editar|eliminar/i,
      });
