        ...
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent className="max-w-xs">
              <p>Todas estas tasas son equivalentes entre sí. Generan el mismo rendimiento o costo financiero.</p>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
      </div>
          ...
          >
            ...
            <CardHeader className="pb-2">
              <CardTitle className="flex items-center gap-2 text-base">
                <div className={`p-2 rounded-lg ${rateTypeColors[item.rateType]} text-white`}>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="text-center">
                <span className={`text-4xl font-bold ${rateTypeTextColors[item.rateType]}`}>
      ...
      <Card className="bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-800">
        <CardContent className="pt-4">
          <div className="flex gap-3">
            <div className="p-2 rounded-lg bg-gray-200 dark:bg-gray-800 h-fit">
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              ...
              <ul className="list-disc list-inside space-y-1">
                <li>
                  <strong>Tasas Efectivas:</strong> Incluyen el efecto del interés compuesto. EA (anual), EM (mensual), ED (diaria).
                </li>
                <li>
                  <strong>Tasas Nominales:</strong> No incluyen capitalización directamente. Se dividen por el número de períodos.
                </li>
                <li>
                  <strong>Equivalencia:</strong> Una tasa del {formatRateAsPercentage(conversions.ea, 2)} EA genera el mismo rendimiento que {formatRateAsPercentage(conversions.em, 4)} mensual.
                </li>
              </ul>
            </div>
          </div>
